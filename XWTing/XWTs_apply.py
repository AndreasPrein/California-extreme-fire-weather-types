...
def HUC2_XWTs_apply(Season,
    ...
    if (Season == 'Annual') & (Region == 'Bay_Area'):
        VarsFullName=['RH2AVG','MF2AVG','V850']
...
#         SpatialSmoothing=0.5 #[0,0.5,1]
    ...
    return rgdTime, iMonths, sPlotDir, sDataDir, sSubregionPR, rgsWTvars, VarsFullName,rgsWTfolders, rgrNrOfExtremes, WT_Domains, DomDegreeAdd, Annual_Cycle, SpatialSmoothing, Metrics, Dimensions, FireObs, ClusterMeth, ClusterBreakup, RelAnnom, NormalizeData, MinDistDD, RemoveAnnualCycl
