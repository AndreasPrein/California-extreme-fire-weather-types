...
# # UV500_1900-2010.ipynb

# In[2]:


'''
    File name: UV500_1900-2010.ipynb
    ...
    1) Reads in U500 and V500 variables from the ERA-20C
...
#             print( '        Save data to '+File_fin)
            ...
            UV.standard_name = "500 hPa wind speed"
            UV.long_name = "500 hPa wind speed"
            UV.units = "m s-1"
